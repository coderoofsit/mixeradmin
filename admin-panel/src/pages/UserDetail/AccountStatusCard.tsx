      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between p-3 bg-var(--bg-tertiary) rounded-lg">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-var(--text-primary)">Background Check</span>
          </div>
          <span className={`badge ${getVerificationBadge(accountDetails.backgroundVerification)}`}>
            {accountDetails.backgroundVerification}
          </span>
        </div>
